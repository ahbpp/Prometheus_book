...
для мониторинга событий и сигнализации в реальном времени. Проект был
 ...
 Разработчики Prometheus утверждают, что на рынке не существовало инструментов, позволяющих решать ее без проблем.  
...
Для операционных систем `mac os` и `Linux` установка очень проста. Для начала
...
Таких компонентов уже написано много под различные сервисы и ПО, весь список
...
Список поддерживаемых баз данных на [сайте](https://prometheus.io/docs/operating/integrations/#remote-endpoints-and-storage).
...
В первую очередь стоит упомянуть о совместимости Prometheus и отличного графического визуализатора [Gafana](https://grafana.com/). Установить ее можно по [инструкции](https://grafana.com/grafana/download/)
